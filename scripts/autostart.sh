...
bash ~/linux/scripts/run_once.sh "trayer-srg" "trayer-srg --edge top --align right --SetDockType true --SetPartialStrut true --expand true --width 10 --transparent true --tint 0x00000000 --height 18 --monitor primary"
